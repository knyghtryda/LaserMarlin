...
#define FAN_PIN            -1//4 // IO pin. Buffer needed
...
#define PS_ON_PIN          -1//12
 ...
 #define HEATER_0_PIN       -1//10   // EXTRUDER 1
...
#define TEMP_BED_PIN       -1//14   // ANALOG NUMBERING
  ...
  #define SERVO0_PIN         11
    ...
    #define LCD_PINS_RS 8//16
    #define LCD_PINS_ENABLE 9//17
    #define LCD_PINS_D4 4//23
    #define LCD_PINS_D5 5//25
    #define LCD_PINS_D6 6//27
    #define LCD_PINS_D7 7//29
#ifdef LCDSHIELD
#define BTN_ANALOG 54 // A0
#endif
  #endif
#endif // ULTRA_LCD
